...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\textbf{Proof:} \\
			By quotient remainder theorem, $n=3q+r$ and $0 \leq r < 3$. \\
		...
		\begin{tabular}{|l|}
			...
			\hline
			\textbf{Proof:} \\
			Assume opposite and $ab \in \mathbb{Q}$. \\
		...
		$y=ax$ \\
		By Theorem A, $y$ must be irrational. \\
		...
		\begin{enumerate}
			...
			\begin{tabular}{|l|}
				...
				\begin{tabular}{|l|}
					...
					Because $a\geq1$ and $b\geq1$, $ab>b\sqrt{n}$ and $b\sqrt{n}>n$. \\
					$ab>n$ \\
