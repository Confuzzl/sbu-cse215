...
%	$m+n+2\sqrt{mn}$ is a perfect square.
	...
	The maximum cardinality of $\mathbb{T}$ is $10^{12}$. By quotient remainder theorem, remainders of division by $10^{12}$ are in the range $\left[0,10^{12}\right)$. The largest $\mathbb{T}$ possible contains all these remainders. \\
